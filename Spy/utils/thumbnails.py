...
from Spy.youtube_search import VideosSearch 
...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            font_title = ImageFont.truetype("Spy/assets/font.ttf", 45)
            font_details = ImageFont.truetype("Spy/assets/font2.ttf", 30)
            font_watermark = ImageFont.truetype("Spy/assets/font2.ttf", 25)
        except:
        ...
        stats_text = f"YouTube : {views} | Time : {duration} | Player : @cuteanubot"
