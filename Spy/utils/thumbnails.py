...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("Spy/assets/ISTKHAR/font2.ttf", 32)
        regular_font = ImageFont.truetype("Spy/assets/ISTKHAR/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "Spy/assets/ISTKHAR/play_icons.png"
